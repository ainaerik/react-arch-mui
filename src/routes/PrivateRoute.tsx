 ...
 * @returns
 */
const PrivateRoute = ({ component: Component, roles, ...rest }: PropsWithChildren<PrivateRouteInterface>) => {
  ...
  return isLoading ? (
    ...
    <Route {...rest} render={(props) => (isGranted && isAuthenticated ? <Component {...props} /> : redirectTo())} />
  )
}
